...
export declare const createMetaplex: (connection: Connection, keypair: Keypair) => Metaplex;
export declare const solInstructionsUsingMetaplex: (metaplex: Metaplex, toOwner: PublicKey, amount: number) => TransactionInstruction[];
export declare const splInstructionsUsingMetaplex: (metaplex: Metaplex, toOwner: PublicKey, amount: number, splToken: PublicKey) => Promise<TransactionInstruction[]>;
export declare const nftInstructionsUsingMetaplex: (metaplex: Metaplex, toOwner: PublicKey, splToken: PublicKey, amount?: number) => Promise<TransactionInstruction[]>;
