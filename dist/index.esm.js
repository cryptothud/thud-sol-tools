...
export const isBlockhashExpired = async (connection, lastValidBlockHeight) => {
...
export const confirmSignatureStatus = async (signature, connection, lastValidHeight) => {
...
/* 
  ...
  * )
*/
export const sendSolanaTransaction = async (wallet, connection, instructions, lastAttempt) => {
...
/* 
  ...
  * )
*/
export const sendV0SolanaTransaction = async (wallet, connection, instructions, lastAttempt) => {
    // starts at 0 to keep track and make sure it doesn't keep trying forever
    let attempt = (lastAttempt ?? 0) + 1
    const blockhashResponse = await connection.getLatestBlockhashAndContext('finalized');
    const lastValidHeight = blockhashResponse.value.lastValidBlockHeight;
...
/* 
  ...
  * )
*/
export const sendSolanaTransactionWithSigner = async (wallet, connection, instructions, lastAttempt) => {
    // starts at 0 to keep track and make sure it doesn't keep trying forever
    let attempt = (lastAttempt ?? 0) + 1
    const blockhashResponse = await connection.getLatestBlockhashAndContext('finalized');
    const lastValidHeight = blockhashResponse.value.lastValidBlockHeight;
...
export const createMetaplex = (connection, keypair) => {
...
export const solInstructionsUsingMetaplex = (metaplex, toOwner, amount) => {
...
export const splInstructionsUsingMetaplex = async (metaplex, toOwner, amount, splToken) => {
...
*/
export const nftInstructionsUsingMetaplex = async (metaplex, toOwner, splToken, amount) => {
...
export const solInstruction = (fromPubkey, toPubkey, amount) => {
...
export const splInstructions = async (fromPubkey, toPubkey, amount, token, connection) => {
    let instructions = []
